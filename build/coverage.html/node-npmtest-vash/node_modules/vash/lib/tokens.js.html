...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-vash/node_modules/vash/lib/tokens.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-vash/node_modules/vash/lib/tokens.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-vash/node_modules/vash/lib/</a> &#187; tokens.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// The order of these is important, as it is the order in which
...
&nbsp;
  ...
  , 'COLON', (/^(:)/)
  , 'PERIOD', (/^(\.)/)
  , 'NEWLINE', <span class="fstat-no" title="function not covered" >function(){</span>
<span class="cstat-no" title="statement not covered" >    var token = this.scan(/^(\n)/, exports.NEWLINE);</span>
<span class="cstat-no" title="statement not covered" >    if(token){</span>
<span class="cstat-no" title="statement not covered" >      this.lineno++;</span>
